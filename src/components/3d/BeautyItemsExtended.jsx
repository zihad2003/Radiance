...
export const BrushPowder = (props) => {
    ...
    return (
        <group ref={groupRef} {...props}>
            ...
            <Cylinder args={[0.09, 0.07, 1.4, 32]} position={[0, -0.6, 0]}>
            ...
            <Cylinder args={[0.11, 0.09, 0.5, 32]} position={[0, 0.35, 0]}>
                <meshStandardMaterial
                    color="#B76E79"
                    metalness={1}
                    roughness={0.1}
            ...
            <Torus args={[0.1, 0.005, 16, 32]} position={[0, 0.25, 0]} rotation={[Math.PI / 2, 0, 0]}>
                <meshStandardMaterial color="#8B4513" metalness={0.8} roughness={0.2} />
            </Torus>

            {/* Fluffy Bristles */}
            <Sphere args={[0.2, 32, 32]} position={[0, 0.75, 0]} scale={[1, 1.8, 0.8]}>
                <meshStandardMaterial
                    color="#5D4037"
                    roughness={0.95}
                    normalScale={[2, 2]}
...
export const BrushEyeshadow = (props) => {
    ...
    return (
        <group ref={groupRef} {...props}>
            ...
            <Cylinder args={[0.06, 0.05, 1.2, 32]} position={[0, -0.5, 0]}>
                <meshStandardMaterial
                    color="#FFB6C1"
                    roughness={0.2}
                    metalness={0.3}
            ...
            {/* Ferrule - Silver */}
            <Cylinder args={[0.08, 0.06, 0.35, 32]} position={[0, 0.3, 0]}>
                <meshStandardMaterial
                    color="#C0C0C0"
                    metalness={1}
                    roughness={0.15}
            ...
            {/* Precision Bristles */}
            <Cylinder args={[0.06, 0.02, 0.3, 32]} position={[0, 0.55, 0]}>
                <meshStandardMaterial
                    color="#3E2723"
                    roughness={0.9}
                />
...
export const BrushKabuki = (props) => {
    ...
    return (
        <group ref={groupRef} {...props}>
            {/* Short Handle - Wooden */}
            <Cylinder args={[0.12, 0.1, 0.6, 32]} position={[0, -0.2, 0]}>
                <meshStandardMaterial
                    color="#8B4513"
                    roughness={0.6}
                    metalness={0.1}
            ...
            {/* Ferrule - Gold */}
            <Cylinder args={[0.14, 0.12, 0.3, 32]} position={[0, 0.25, 0]}>
                <meshStandardMaterial
                    color="#D4AF37"
                    metalness={1}
                    roughness={0.1}
            ...
            {/* Dense Bristles */}
            <Sphere args={[0.25, 32, 32]} position={[0, 0.55, 0]} scale={[1, 1.2, 1]}>
                <meshStandardMaterial
                    color="#2C1810"
                    roughness={0.95}
                />
...
export const NailPolishClassic = (props) => {
    ...
    return (
        <group ref={groupRef} {...props}>
            {/* Glass Bottle */}
            <Cylinder args={[0.28, 0.32, 0.6, 64]} position={[0, 0, 0]}>
            ...
            {/* Red Polish Inside */}
            <Cylinder args={[0.25, 0.29, 0.5, 64]} position={[0, -0.03, 0]}>
                <meshStandardMaterial
                    color="#DC143C"
                    roughness={0.1}
                    metalness={0.3}
            ...
            <Cylinder args={[0.12, 0.16, 0.5, 32]} position={[0, 0.55, 0]}>
                <meshStandardMaterial
                    color="#0a0a0a"
                    metalness={0.6}
                    roughness={0.3}
            ...
            {/* Brush Stem */}
            <Cylinder args={[0.02, 0.02, 0.4, 16]} position={[0, 0.2, 0]}>
            ...
            {shadeColors.map((color, i) => {
                ...
                return (
                    <group key={i} position={[x, 0.08, z]}>
                        {/* Pan */}
                        <Cylinder args={[0.15, 0.15, 0.03, 32]}>
                            <meshStandardMaterial
                                color={color}
...
export const Mascara = (props) => {
    ...
    return (
        <group ref={groupRef} {...props}>
            {/* Tube - Sleek Black */}
            <Cylinder args={[0.1, 0.1, 1.4, 64]} position={[0, 0, 0]}>
                <meshStandardMaterial
                    color="#0a0a0a"
                    metalness={0.9}
                    roughness={0.1}
            ...
            {/* Gold Accent Bands */}
            <Torus args={[0.1, 0.015, 16, 64]} position={[0, 0.3, 0]} rotation={[Math.PI / 2, 0, 0]}>
            ...
            <Torus args={[0.105, 0.008, 16, 64]} position={[0, 0, 0]} rotation={[Math.PI / 2, 0, 0]}>
                <meshStandardMaterial color="#C0C0C0" metalness={1} roughness={0.1} />
            </Torus>

            {/* Cap */}
            <Cylinder args={[0.08, 0.12, 0.4, 64]} position={[0, 0.9, 0]}>
                <meshStandardMaterial
                    color="#1a1a1a"
                    metalness={0.8}
                    roughness={0.15}
...
export const SkincareJar = (props) => {
    ...
    return (
        <group ref={groupRef} {...props}>
            {/* Glass Jar */}
            <Cylinder args={[0.45, 0.45, 0.6, 64]} position={[0, 0, 0]}>
                <meshPhysicalMaterial
                    transmission={0.85}
                    roughness={0.1}
                    thickness={0.2}
            ...
            {/* Cream Inside */}
            <Cylinder args={[0.42, 0.42, 0.4, 64]} position={[0, -0.08, 0]}>
                <meshStandardMaterial
                    color="#FFFACD"
                    roughness={0.7}
                    metalness={0.1}
            ...
            {/* Rose Gold Lid */}
            <Cylinder args={[0.48, 0.48, 0.15, 64]} position={[0, 0.375, 0]}>
                <meshStandardMaterial
                    color="#B76E79"
                    metalness={1}
                    roughness={0.08}
            ...
            {/* Decorative Top */}
            <Torus args={[0.4, 0.02, 16, 64]} position={[0, 0.45, 0]} rotation={[Math.PI / 2, 0, 0]}>
                <meshStandardMaterial color="#D4AF37" metalness={1} roughness={0.05} />
            </Torus>

            {/* Logo Emblem */}
            <Cylinder args={[0.1, 0.1, 0.02, 32]} position={[0, 0.46, 0]}>
                <meshStandardMaterial
                    color="#FFD700"
                    metalness={1}
                    roughness={0.1}
...
export const Pearl = (props) => {
    ...
    return (
        <Sphere ref={groupRef} args={[0.5, 64, 64]} {...props}>
            <meshStandardMaterial
                color="#FFF0F5"
                metalness={0.2}
                roughness={0.1}
